...
const Index = () => {
  ...
  useEffect(() => {
    const profile = localStorage.getItem("stylevault_profile");
      ...
      <div className="relative flex-1 flex items-end">
        ...
        <div className="relative z-10 w-full max-w-lg mx-auto px-6 pb-12 pt-40 text-center">
          ...
          <p className="text-muted-foreground mt-4 text-lg leading-relaxed">
            Your AI-powered personal stylist. Daily outfits curated from your closet, 
            your weather, and your life.
          </p>
          <Button
          ...
          <p className="text-xs text-muted-foreground mt-4">Free · No account needed</p>
        </div>
      </div>
    </div>
  );
